! function() {
    ...
    Function && Function.prototype && Function.prototype.bind && (/MSIE [678]/.test(navigator.userAgent) || ! function e(t, n, i) {
        ...
        function u() {
            var t, e, n = l.url(f.CLIENT_EVENT_ENDPOINT, {
                    dnt: 0,
                    l: ""
                }),
        ...
        function i(t, e, n, i) {
            return t = t || [], n = n || {},
                function() {
                    var r, s, c, d, h = Array.prototype.slice.apply(arguments, [0, t.length]),
        ...
        function s(t, e, n) {
            ...
            if (t = f.devicePixelRatio ? t * f.devicePixelRatio : t, s = e.split(",").map(function(t) {
                ...
                for (a = 0; a < s.length; a++) s[a].url === n && (i = s[a]);
        ...
        i.prototype = new a, w.aug(i.prototype, {
            ...
            requestTweets: function(t, e, n) {
                ...
                e && this.cursors.maxPosition ? r.minPosition = this.cursors.maxPosition : !e && this.cursors.minPosition ? r.maxPosition = this.cursors.minPosition : e ? r.sinceId = t : r.maxId = t, r.complete = function() {
                    ...
                    var r, s, o = i.sandbox.createDocumentFragment(),
            ...
            gcTweets: function(t) {
                var e, n = this.element.querySelector(L),
                    i = n.children.length;
            ...
            hideStreamScrollBar: function() {
                var t, e = this.element.querySelector(P),
            ...
            showNSFW: function(t) {
                var e, n, i, r, s, o, a = t.querySelector(".nsfw"),
                    c = 0;
        ...
        function i(t) {
            ...
            var e = this.params(),
                ...
                s = "" + (e.shareWithRetweet || this.dataAttr("share-with-retweet") || a.val("share-with-retweet"));
